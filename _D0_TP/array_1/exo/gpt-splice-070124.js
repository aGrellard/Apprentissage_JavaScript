...
const supprimeFruits = fruits.splice(2, 2);
...
fruits.splice(2, 0, "abricot", "pêche");
...
const inverseLettres = [...lettres].reverse();
...
personnes.splice(2, 0, { nom: "Eve", age: 29 }, { nom: "Frank", age: 31 });
...
// Exemple de réponse attendue : [1, 2, 3]
const sousEnsembleNombres = nombres.splice(0, 3);
...
personnes.splice(2, 1, { nom: "Gary", age: 27 }, { nom: "Helen", age: 24 });
