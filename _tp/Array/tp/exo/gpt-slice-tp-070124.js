...
const milieuFruits = fruits.slice(2,5);
...
const premiersNombresDoubles = nombres.slice(0, 3).map(v=>v*2);
...
const sansKiwi = fruits.slice(0, 3);
sansKiwi.push(...fruits.slice(4))
