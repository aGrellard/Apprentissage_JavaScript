...
const filter_4 = aliments.filter(item=>item.quantity<=10).map(item=>{return{name:item.name,qty:item.quantity}});
...
// **************************************************
console.log(nombres);
const map_1 = nombres.map(item=>{return {isNotPair:item%2}});
...
// **************************************************
console.log(aliments);
let map_3 = aliments.map(item=>{return `il reste ${item.quantity}/g de ${item.name}`});
...
// **************************************************
console.log(utilisateurs_1);
let map_4 = utilisateurs_1.map(item=>{return {...item, new:"Hello"}});
...
// **************************************************
console.log(fruits);
let sort_3 = fruits.sort((a,b)=>{return a.localeCompare(b)});
